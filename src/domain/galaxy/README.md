...
| ------------------------ | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| [`galaxy.ts`](galaxy.ts) | Generierungsprofile, statische Galaxieobjekte und Invarianten | [`galaxiestruktur-und-generierung.md`](../../../docs/docs/02-galaxy/galaxiestruktur-und-generierung.md) |
